export default function Navbar() {
    return (
        <nav className="navbar p-3 bg-base-100 shadow-sm sticky top-0">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost text-cyan-600 text-xl rounded-2xl">Dental Center</a>
            </div>
            <div className="navbar-center text-slate-800  hidden lg:flex">
